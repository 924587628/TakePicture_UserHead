...
import com.ycl.chooseavatar.library.R;
...
public class CropImageView extends ImageView {
    ...
    private boolean mIsHandleShadowEnabled = false;
    
    public static final int Clip_w_h = 150;
...
//        canvas.drawCircle(rect.right, rect.bottom, mHandleSize, mPaintFrame);
    ...
    private RectF calcFrameRect(RectF imageRect) {
        ...
        float frameW = getRatioX(px2dip(getContext(), Clip_w_h));
        float frameH = getRatioY(px2dip(getContext(), Clip_w_h));
